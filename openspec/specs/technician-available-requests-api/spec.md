# technician-available-requests-api Specification

## Purpose

Provides a backend endpoint for fetching pending service requests available to the demo technician, filtered by assigned categories and zones.
